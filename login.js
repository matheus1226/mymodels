class Login{
    ...
    static endpoint="https://testeee.cavera159.repl.co/"
    static config={
        cor:"#048",
        img:"./logo.png"
    };
    ...
    static login=(callback_ok,callback_naook,config=null)=>{
        ...
        ".campoLogin input{font-size:18px; padding:5px; background-color:#fff; border-radius:5px; width:130%}"+
    ...
    static verificaLogin=()=>{
        ...
        console.log("entrei no verificar login")

        const endpoint = `https://testeee.cavera159.repl.co/?matricula=${mat}&senha=${pas}`;
